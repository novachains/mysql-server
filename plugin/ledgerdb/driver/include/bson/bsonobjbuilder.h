...
#include "bson/bsonnoncopyable.h"
...
#pragma warning( disable : 4355 )
    ...
    */
    ...
    public:
        ...
        BSONArrayBuilder& appendBinData( int len, BinDataType type,
          const char *data ) {
        ...
        BSONArrayBuilder& appendBinData( int len, BinDataType type,
          const unsigned char *data ) {
            return appendBinData(len, type, (const char *) data);
        }
