...
//#if defined(LDB_HAVE_STDINT) || __STDC_VERSION__ >= 199901L
#include <stdint.h>
//#elif defined(LDB_HAVE_UNISTD)
//#include <unistd.h>
//#elif defined(LDB_USE__uint64_t)
//typedef __int64 int64_t;
//typedef unsigned __int64 uint64_t;
//#elif defined(LDB_USE_LONG_LONG_INT)
//typedef long long int int64_t;
//typedef unsigned long long int uint64_t;
//#else
//#error Must compile with c99 or define LDB_HAVE_STDINT, LDB_HAVE_UNISTD, LDB_USE__uint64_t, or LDB_USE_LONG_LONG_INT.
//#endif
 ...
 */
LDB_EXPORT bson* bson_create( void );
 ...
 */
LDB_EXPORT void  bson_dispose(bson* b);
 ...
 * @return the size.
 */
LDB_EXPORT int bson_size( const bson *b );
 ...
 */
LDB_EXPORT int bson_buffer_size( const bson *b );
 ...
 */
LDB_EXPORT void bson_print( const bson *b );
 ...
 */
LDB_EXPORT int bson_sprint_iterator ( char **pbuf, int *left, bson_iterator *i,
                                      char delChar ) ;
 ...
 * @param b the BSON object to print.
 */
LDB_EXPORT int bson_sprint( char *buffer, int bufsize, const bson *b );
 ...
 */
LDB_EXPORT int bson_sprint_length_iterator ( bson_iterator *i ) ;
 ...
 *          0 if failed
 */
LDB_EXPORT int bson_sprint_length( const bson *b );
 ...
 */
LDB_EXPORT const char *bson_data( const bson *b );
 ...
 */
//LDB_EXPORT void bson_print_raw( const char *bson , int depth );
 ...
 */
LDB_EXPORT int bson_sprint_raw ( char **pbuf, int *left, const char *data, int isobj );
 ...
 *          0 if failed
 */
LDB_EXPORT int bson_sprint_length_raw( const char *data, int isobj );
 ...
 */
LDB_EXPORT bson_type bson_find( bson_iterator *it, const bson *obj, const char *name );
 ...
 */
LDB_EXPORT bson_iterator* bson_iterator_create( void );

/**
 * Free a bson_iterator which build on the heap.
 */
LDB_EXPORT void bson_iterator_dispose(bson_iterator*);
/**
 ...
 */
LDB_EXPORT void bson_iterator_init( bson_iterator *i , const bson *b );
 ...
 */
LDB_EXPORT void bson_iterator_from_buffer( bson_iterator *i, const char *buffer );
 ...
 */
LDB_EXPORT bson_bool_t bson_iterator_more( const bson_iterator *i );
 ...
 */
LDB_EXPORT bson_type bson_iterator_next( bson_iterator *i );
 ...
 */
LDB_EXPORT bson_type bson_iterator_type( const bson_iterator *i );
 ...
 */
LDB_EXPORT const char *bson_iterator_key( const bson_iterator *i );
 ...
 */
LDB_EXPORT const char *bson_iterator_value( const bson_iterator *i );
 ...
 * @return  the value of the current BSON object.
 */
LDB_EXPORT double bson_iterator_double( const bson_iterator *i );
 ...
 * @return  the value of the current BSON object.
 */
LDB_EXPORT int bson_iterator_int( const bson_iterator *i );
 ...
 * @return the value of the current BSON object.
 */
LDB_EXPORT int64_t bson_iterator_long( const bson_iterator *i );
 ...
 */
LDB_EXPORT int bson_iterator_decimal_scale( const bson_iterator *i, 
                                            int *sign, int *scale ) ;
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_iterator_decimal_typemod( const bson_iterator *i, 
                                              int *typemod ) ;
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_iterator_decimal_weight( const bson_iterator *i, 
                                             int *weight ) ;
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_iterator_decimal_size( const bson_iterator *i, 
                                           int *size ) ;
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_iterator_decimal( const bson_iterator *i, 
 ...
 * @return the value of the current BSON object.
 */
LDB_EXPORT bson_timestamp_t bson_iterator_timestamp( const bson_iterator *i );
LDB_EXPORT int bson_iterator_timestamp_time( const bson_iterator *i );
LDB_EXPORT int bson_iterator_timestamp_increment( const bson_iterator *i );
...
LDB_EXPORT bson_bool_t bson_iterator_bool( const bson_iterator *i );
 ...
 * @return the value of the current BSON object.
 */
LDB_EXPORT bson_oid_t *bson_iterator_oid( const bson_iterator *i );
...
LDB_EXPORT const char *bson_iterator_string( const bson_iterator *i );
...
/* returns nullptr for everything else */
LDB_EXPORT const char *bson_iterator_code( const bson_iterator *i );
 ...
 */
/* calls bson_empty on scope if not a bson_codewscope */
LDB_EXPORT void bson_iterator_code_scope( const bson_iterator *i, bson *scope );
...
LDB_EXPORT bson_date_t bson_iterator_date( const bson_iterator *i );
 ...
 */
LDB_EXPORT time_t bson_iterator_time_t( const bson_iterator *i );
 ...
 */
LDB_EXPORT int bson_iterator_bin_len( const bson_iterator *i );
 ...
 */
LDB_EXPORT char bson_iterator_bin_type( const bson_iterator *i );
 ...
 */
LDB_EXPORT const char *bson_iterator_bin_data( const bson_iterator *i );
 ...
 */
LDB_EXPORT const char *bson_iterator_regex( const bson_iterator *i );
 ...
 */
LDB_EXPORT const char *bson_iterator_regex_opts( const bson_iterator *i );
 ...
 */
LDB_EXPORT const char *bson_iterator_dbref( const bson_iterator *i );
 ...
 */
LDB_EXPORT bson_oid_t *bson_iterator_dbref_oid( const bson_iterator *i );
 ...
 */
LDB_EXPORT void bson_iterator_subobject( const bson_iterator *i, bson *sub );
 ...
 */
LDB_EXPORT void bson_iterator_subiterator( const bson_iterator *i, bson_iterator *sub );
 ...
 */
LDB_EXPORT void bson_oid_from_string( bson_oid_t *oid, const char *str );
 ...
 */
LDB_EXPORT void bson_oid_to_string( const bson_oid_t *oid, char *str );
 ...
 */
LDB_EXPORT void bson_oid_gen( bson_oid_t *oid );
 ...
 */
LDB_EXPORT void bson_set_oid_fuzz( int ( *func )( void ) );
 ...
 * @param func a pointer to a function that returns an int.
 */
LDB_EXPORT void bson_set_oid_inc( int ( *func )( void ) );
 ...
 */
LDB_EXPORT time_t bson_oid_generated_time( bson_oid_t *oid ); /* Gives the time the OID was created */
 ...
 *      bson_destroy( ).
 */
LDB_EXPORT void bson_init( bson *b );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT void bson_init_size( bson *b, int size );
 ...
 */
LDB_EXPORT int bson_finish( bson *b );
 ...
 *
 */
LDB_EXPORT void bson_destroy( bson *b );
...
LDB_EXPORT bson *bson_empty( bson *obj );
 ...
 */
LDB_EXPORT bson_bool_t bson_is_empty( bson *obj );
 ...
 */
LDB_EXPORT int bson_copy( bson *out, const bson *in ); /* puts data in new buffer. NOOP if out==NULL */
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_oid( bson *b, const char *name, const bson_oid_t *oid );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_new_oid( bson *b, const char *name );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_int( bson *b, const char *name, const int i );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_long( bson *b, const char *name, const int64_t i );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_decimal( bson *b, const char *name, 
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_decimal2( bson *b, const char *name, 
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_decimal3( bson *b, const char *name, 
                                     const char *value ) ;
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_double( bson *b, const char *name, const double d );
 ...
 * @return BSON_OK or BSON_ERROR.
*/
LDB_EXPORT int bson_append_string( bson *b, const char *name, const char *str );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_string_n( bson *b, const char *name, const char *str, int len );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_symbol( bson *b, const char *name, const char *str );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_symbol_n( bson *b, const char *name, const char *str, int len );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_code( bson *b, const char *name, const char *str );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_code_n( bson *b, const char *name, const char *str, int len );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_code_w_scope( bson *b, const char *name, const char *code, const bson *scope );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_code_w_scope_n( bson *b, const char *name, const char *code, int size, const bson *scope );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_binary( bson *b, const char *name, char type, const char *str, int len );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_bool( bson *b, const char *name, const bson_bool_t v );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_null( bson *b, const char *name );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_undefined( bson *b, const char *name );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_regex( bson *b, const char *name, const char *pattern, const char *opts );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_minkey( bson *b, const char *name ) ;
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_maxkey( bson *b, const char *name ) ;
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_bson( bson *b, const char *name, const bson *bson );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_array( bson *b, const char *name, const bson *bson );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_element( bson *b, const char *name_or_null, const bson_iterator *elem );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_elements( bson *dst, const bson *src );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_timestamp( bson *b, const char *name, bson_timestamp_t *ts );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_timestamp2( bson *b, const char *name, int time, int increment );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_date( bson *b, const char *name, bson_date_t millis );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_time_t( bson *b, const char *name, time_t secs );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_start_object( bson *b, const char *name );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_start_array( bson *b, const char *name );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_finish_object( bson *b );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
LDB_EXPORT int bson_append_finish_array( bson *b );
...
LDB_EXPORT void bson_free( void *ptr );
 ...
 * @sa malloc(3)
 */
LDB_EXPORT void *bson_malloc( int size );
 ...
 */
LDB_EXPORT bson_err_handler set_bson_err_handler( bson_err_handler func );
 ...
 *
 */
LDB_EXPORT double bson_int64_to_double( int64_t i64 );

LDB_EXPORT void bson_swap_endian32( void *outp, const void *inp );
LDB_EXPORT void bson_swap_endian64( void *outp, const void *inp );

LDB_EXPORT bson_bool_t bson_is_inf( double d, int *pSign ) ;
 ...
 * shows in ldb shell.
 */
LDB_EXPORT void bson_set_js_compatibility(int compatible);

/**
 * get whether bson_print method will show the string
 * which is the same with that shows in ldb shell or not
 */
LDB_EXPORT int bson_get_js_compatibility();
