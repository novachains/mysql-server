...
#define snprintf _snprintf
    ...
    class StringBuilder {
    public:
       static const size_t LDB_DBL_SIZE = 3 + DBL_MANT_DIG - DBL_MIN_EXP + 1;
       static const size_t LDB_S32_SIZE = 12;
       static const size_t LDB_U32_SIZE = 11;
       static const size_t LDB_S64_SIZE = 23;
       static const size_t LDB_U64_SIZE = 22;
       static const size_t LDB_S16_SIZE = 7;
       static const size_t LDB_PTR_SIZE = 19;
        ...
        StringBuilder& operator<<( double x ) {
            return SBNUM( x , LDB_DBL_SIZE, "%g" );
        }
        StringBuilder& operator<<( int x ) {
            return SBNUM( x , LDB_S32_SIZE, "%d" );
        }
        StringBuilder& operator<<( unsigned x ) {
            return SBNUM( x , LDB_U32_SIZE, "%u" );
        }
        StringBuilder& operator<<( long x ) {
            return SBNUM( x , LDB_S64_SIZE, "%ld" );
        }
        StringBuilder& operator<<( unsigned long x ) {
            return SBNUM( x , LDB_U64_SIZE, "%lu" );
        }
        StringBuilder& operator<<( long long x ) {
            return SBNUM( x , LDB_S64_SIZE, "%lld" );
        }
        StringBuilder& operator<<( unsigned long long x ) {
            return SBNUM( x , LDB_U64_SIZE, "%llu" );
        }
        StringBuilder& operator<<( short x ) {
            return SBNUM( x , LDB_S16_SIZE, "%hd" );
        }
